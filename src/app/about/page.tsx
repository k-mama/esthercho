...
export const metadata: Metadata = {
  ...
  description:
    "Meet Esther Cho, the international author name of Korean writer and artist 議곗꽦??",
};
  ...
  return (
    <article className="esther-page">
      ...
      <footer className="container esther-closing">
        <p className="esther-eyebrow">ESTHER CHO 쨌 議곗꽦??/p>
        <p>
